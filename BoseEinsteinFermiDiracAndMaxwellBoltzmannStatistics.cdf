...
NotebookDataLength[     83664,       1731]
NotebookOptionsPosition[     56067,       1135]
NotebookOutlinePosition[     82355,       1696]
CellTagsIndexPosition[     82244,       1690]
WindowTitle->Bose-Einstein, Fermi-Dirac, and Maxwell-Boltzmann Statistics
WindowFrame->Normal*)
...
Cell["Bose-Einstein, Fermi-Dirac, and Maxwell-Boltzmann Statistics", \
"DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`TT$$ = 300, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`TT$$], 300, "T(K)"}, 0.1, 10000}}, Typeset`size$$ = {
    550., {208., 213.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`TT$549$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`TT$$ = 300}, 
      "ControllerVariables" :> {
        Hold[$CellContext`TT$$, $CellContext`TT$549$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Plot[
         Evaluate[
          Table[
          1/(Exp[$CellContext`x/($CellContext`kb $CellContext`TT$$)] + \
$CellContext`\[Epsilon]), {$CellContext`\[Epsilon], {-1, 0, 
            1}}]], {$CellContext`x, $CellContext`a, 0}, PlotStyle -> {{
            Hue[0.1], Thick}, {
            Hue[0.4], Thick}, {
            Hue[0.6], Thick}}, Exclusions -> {$CellContext`a, 0}], 
        Plot[
         Evaluate[
          Table[
          1/(Exp[$CellContext`x/($CellContext`kb $CellContext`TT$$)] + \
$CellContext`\[Epsilon]), {$CellContext`\[Epsilon], {-1, 0, 
            1}}]], {$CellContext`x, 0, $CellContext`b}, PlotStyle -> {{
            Hue[0.1], Thick}, {
            Hue[0.4], Thick}, {
            Hue[0.6], Thick}}, Exclusions -> {$CellContext`a, 0}], 
        AxesLabel -> {"E - \[Mu] [meV]", 
          Row[{"<", 
            Style["N", Italic], "(", 
            Style["E", Italic], ")>"}]}, AxesStyle -> {
          Directive[14], 
          Directive[14]}, PlotRange -> {0, 2}, 
        AxesOrigin -> {0, $CellContext`b}, ImageSize -> 550, Epilog -> Inset[
          Panel[
           Grid[{{
              Graphics[{
                Hue[0.1], Thick, 
                Line[{{0, 0}, {1, 0}}]}, ImageSize -> 15, AspectRatio -> 0.1],
               "Bose-Einstein, \[Epsilon] = -1"}, {
              Graphics[{
                Hue[0.4], Thick, 
                Line[{{0, 0}, {1, 0}}]}, ImageSize -> 15, AspectRatio -> 0.1],
               "Maxwell-Boltzmann, \[Epsilon] = 0"}, {
              Graphics[{
                Hue[0.6], Thick, 
                Line[{{0, 0}, {1, 0}}]}, ImageSize -> 15, AspectRatio -> 0.1],
               "Fermi-Dirac, \[Epsilon] = +1"}}]], {725, 1.75}], PlotLabel -> 
        Row[{"distribution function: ", 
           Style[
            TraditionalForm[
            1/(Exp[(Style[
                 "E", Italic] - $CellContext`\[Mu])/($CellContext`k \
$CellContext`T)] + $CellContext`\[Epsilon])], Large]}]], 
      "Specifications" :> {{{$CellContext`TT$$, 300, "T(K)"}, 0.1, 10000, 
         Appearance -> "Labeled"}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{595., {252., 257.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`kb = 
        0.08618292134831462, $CellContext`a = -500, $CellContext`b = 1000, 
        Attributes[PlotRange] = {ReadProtected}}; Typeset`initDone$$ = True); 
     ReleaseHold[
       HoldComplete[{$CellContext`a = -500; $CellContext`b = 
          1000; $CellContext`kb = 0.08618292134831462; Null}]]; 
...
Cell[TextData[{
 ...
 " of the Bose\[Dash]Einstein, Fermi\[Dash]Dirac, and Maxwell\[Dash]Boltzmann \
thermodynamic statistics. The ",
 Cell[BoxData[
  FormBox["x", TraditionalForm]], "InlineMath"],
 " coordinate is ",
 Cell[BoxData[
  FormBox[
   RowBox[{"E", "-", "\[Mu]"}], TraditionalForm]], "InlineMath"],
 ", where ",
 Cell[BoxData[
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox["\[Mu]", TraditionalForm]], "InlineMath"],
 " is the change of a characteristic state function per change in the number \
of particles. More precisely it is the thermodynamic conjugate of the \
particle number. It can be interpreted, for example, as the ability of the \
system to perform phase transitions or chemical reactions, or its tendency to \
diffuse. In the case of massless particles, such as a gas of photons, ",
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Mu]", "=", "0"}], TraditionalForm]], "InlineMath"],
 " because the number of particles in the ensemble is not conserved."
}], "ManipulateCaption",
 CellID->427494871],

Cell[TextData[{
 "The Fermi\[Dash]Dirac statistics describe the population density of a gas \
of fermions. As ",
 Cell[BoxData[
  FormBox[
   RowBox[{"T", "\[Rule]", "0"}], TraditionalForm]], "InlineMath"],
 " it becomes a step function; the fermions in the gas populate states with \
an energy ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["E", "n"], "\[LessEqual]", "\[Mu]"}], TraditionalForm]], 
  "InlineMath"],
 ", while states with ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["E", "n"], ">", "\[Mu]"}], TraditionalForm]], "InlineMath"],
 " are not occupied. The reason is that fermions obey Pauli's exclusion \
principle, which states that two particles cannot populate the same state at \
the same time."
}], "ManipulateCaption",
 CellID->465028450],

Cell[TextData[{
 "The Bose\[Dash]Einstein statistics describes a gas of bosons. Since they do \
not obey Pauli's exclusion principle, the same state can be populated by more \
than one particle; the distribution function diverges for ",
 Cell[BoxData[
  FormBox[
   RowBox[{"E", "\[Rule]", "\[Mu]"}], TraditionalForm]], "InlineMath"],
 "."
}], "ManipulateCaption",
 CellID->205487540],

Cell[TextData[{
 "Maxwell\[Dash]Boltzmann statistics apply where quantum-mechanical effects \
do not play a role and the particles of the gas can be considered \
\"distinguishable\". Both Fermi\[Dash]Dirac and Bose\[Dash]Einstein \
statistics become Maxwell\[Dash]Boltzmann statistics at high temperatures and \
low chemical potentials where ",
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Mu]", "<", "0"}], TraditionalForm]], "InlineMath"],
 "."
...
Cell[TextData[{
 ButtonBox["Bose-Einstein Distribution",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Bose-EinsteinDistribution.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Boson",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Boson.html"], None}],
 " (",
...
Cell[TextData[{
 ButtonBox["Fermi-Dirac Distribution",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Fermi-DiracDistribution.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Fermion",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Fermion.html"], None}],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Maxwell Distribution",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/MaxwellDistribution.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Pauli Exclusion Principle",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/PauliExclusionPrinciple.\
html"], None}],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
...
BoseEinsteinFermiDiracAndMaxwellBoltzmannStatistics&version=0012"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
BoseEinsteinFermiDiracAndMaxwellBoltzmannStatistics/\
BoseEinsteinFermiDiracAndMaxwellBoltzmannStatistics-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Bose-Einstein, Fermi-Dirac, and Maxwell-Boltzmann Statistics",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
BoseEinsteinFermiDiracAndMaxwellBoltzmannStatistics/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
BoseEinsteinFermiDiracAndMaxwellBoltzmannStatistics/"],
 "\"",
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Christian Freier",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Christian+\
Freier"], None}],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[41953, 765, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[42214, 774, 3722, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55245, 1110, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 81957, 1679},
 {"Copyright", 82152, 1684}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[624, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34955, 590, 83, 1, 70, "DemoTitle"],
Cell[35041, 593, 3889, 84, 70, "Output",
 CellID->13014436],
Cell[38933, 679, 641, 20, 70, "ManipulateCaption",
 CellID->149853251],
Cell[39577, 701, 713, 14, 70, "ManipulateCaption",
 CellID->427494871],
Cell[40293, 717, 782, 22, 70, "ManipulateCaption",
 CellID->465028450],
Cell[41078, 741, 384, 9, 70, "ManipulateCaption",
 CellID->205487540],
Cell[41465, 752, 485, 11, 70, "ManipulateCaption",
 CellID->58510673],
Cell[41953, 765, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[42214, 774, 3722, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45939, 858, 44, 0, 70, "RelatedLinksSection"],
Cell[45986, 860, 591, 20, 70, "RelatedLinks",
 CellID->200044037],
Cell[46580, 882, 404, 14, 70, "RelatedLinks",
 CellID->159199928],
Cell[46987, 898, 587, 20, 70, "RelatedLinks",
 CellID->241045628],
Cell[47577, 920, 408, 14, 70, "RelatedLinks",
 CellID->901165149],
Cell[47988, 936, 579, 20, 70, "RelatedLinks",
 CellID->274296705],
Cell[48570, 958, 442, 15, 70, "RelatedLinks",
 CellID->9221265],
Cell[49015, 975, 4896, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53914, 1068, 45, 0, 70, "CitationSection"],
Cell[53962, 1070, 996, 27, 70, "Citations"],
Cell[54961, 1099, 281, 9, 70, "Author"],
Cell[55245, 1110, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature LQEAPiQa4o5RnuARFA02YHc1 *)
